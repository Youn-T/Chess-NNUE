...
labels = cp.load('Cupy HalfKP V2/labels_halfKP_V2.npz')["Y"]
matrix_cpu = sparse.load_npz('Cupy HalfKP V2/moves_halfKP_V2.npz')
...
cp.savez('Cupy HalfKP V2/model_halfKP_V2.npz', W1=W1, b1=b1, W2=W2, b2=b2, W3=W3, b3=b3, W4=W4, b4=b4)
print("Modèle sauvegardé sous 'Cupy HalfKP V2/model_halfKP_V2.npz'")